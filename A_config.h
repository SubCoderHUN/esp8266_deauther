...
// ===== DISPLAY ===== //
  #define SH1106_I2C
  #define FLIP_DIPLAY true
  #define DISPLAY_TEXT "Novak Zalan"
...
#ifndef LED_MODE_HIBERNATED
  #define LED_MODE_HIBERNATED 255, 110, 0
#endif /* ifndef LED_MODE_HIBERNATED */
