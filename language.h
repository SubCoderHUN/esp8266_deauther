...
const char CLI_SUBCODER[] PROGMEM = "subcoder/s";                // chicken, chickens
...
const char CLI_SUBCODER_OUTPUT[] PROGMEM =
" ######  ##     ## ########   ######   #######  ########  ######## ######## \r\n"  
"##    ## ##     ## ##     ## ##    ## ##     ## ##     ## ##       ##     ##\r\n" 
"##       ##     ## ##     ## ##       ##     ## ##     ## ##       ##     ##\r\n" 
" ######  ##     ## ########  ##       ##     ## ##     ## ######   ######## \r\n"  
...
const char CLI_INFO_SOFTWARE[] PROGMEM = "ESP8266 Deauther - SmartWatch";
const char CLI_INFO_COPYRIGHT[] PROGMEM = "2018 (c) Stefan Kremser && 2020 (c) Novák Zalán";
const char CLI_INFO_LICENSE[] PROGMEM = "This software is licensed under the MIT License.";
const char CLI_INFO_ADDON[] PROGMEM = "For more information please visit github.com/spacehuhn/esp8266_deauther. For modified version: https://github.com/SubCoderHUN/ESP8266_Deauther_custom";
...
const char D_STATUSLED[] PROGMEM = "STATUS LED";
